          ...
          <AnimatedSection>
            <div className="max-w-xl">
              <span className="inline-flex items-center gap-2 px-4 py-1.5 bg-white/10 backdrop-blur-xl rounded-full text-sm text-emerald-200 border border-white/10 mb-5">
                ...
                <span className="inline-flex items-center gap-2 px-4 py-1.5 bg-[#F97316] text-white rounded-full text-sm font-bold ml-2 mb-5">
              ...
              <div className="flex items-center gap-4">
                  <Link href="/contact" className="inline-flex items-center gap-2 bg-[#F97316] text-white px-7 py-3.5 rounded-2xl font-bold hover:bg-[#EA580C] transition-all shadow-xl hover:-translate-y-0.5">
                ...
                >
                  ...
                  <div className="p-5">
                    <div className="flex items-center justify-between mb-2">
                      ...
                      <span className="text-lg font-bold text-[#F97316]">{currency}{s.price}</span>
                    </div>
                    ...
                    <div className="mt-4 pt-3 border-t border-gray-100 flex items-center justify-between">
                      ...
                      <span className="flex items-center gap-1 text-xs font-medium text-[#F97316] group-hover:gap-2 transition-all">
              ...
              {testimonials.slice(0, 3).map((rev) => (
                ...
                >
                  ...
                  <div className="flex items-center gap-3 pt-3 border-t border-gray-100">
                    <div className="w-9 h-9 bg-gradient-to-br from-[#DBEAFE] to-[#EFF6FF] rounded-full flex items-center justify-center text-xs font-bold text-[#F97316]">{rev.initials}</div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative w-full">
          <AnimatedSection>
            ...
            <p className="text-emerald-100/60 mb-8 max-w-md mx-auto text-lg">
              ...
              <Link href="/contact" className="inline-flex items-center gap-2 bg-[#F97316] text-white px-8 py-3.5 rounded-2xl font-bold hover:bg-[#EA580C] transition-all shadow-xl hover:-translate-y-0.5">
              {t.vet.bookNow}
