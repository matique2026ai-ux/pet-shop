...
function ProductsContent() {
  ...
  return (
    <div dir={dir} className="min-h-screen">
      ...
      ══════════════════════════════════ */}
      <section className="relative overflow-hidden py-14 lg:py-20 bg-gradient-to-br from-[#13111C] via-[#1A1A2E] to-[#0D0B14] text-white">
        {/* Glow & Paw Decor */}
      ...
      <section className="py-6 border-b border-gray-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col sm:flex-row gap-4 items-start sm:items-center justify-between">
            ...
            <div className="flex items-center gap-2 overflow-x-auto no-scrollbar py-1 w-full max-w-full touch-pan-x touch-pan-y">
