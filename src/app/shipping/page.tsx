  ...
  return (
    <div>
      <section className="relative overflow-hidden py-16 lg:py-24 flex items-center min-h-[50vh]">
        <div className="absolute inset-0 bg-gradient-to-br from-[#F8FAFC] via-[#f5f5f5] to-white" />
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full">
          <AnimatedSection>
            <span className="inline-flex items-center gap-2 px-4 py-1.5 bg-[#1E3A8A]/10 rounded-full text-sm text-[#1E3A8A] border border-[#1E3A8A]/15 mb-4">
              <Sparkles className="w-4 h-4" /> {t.shipping.title}
            </span>
            <h1 className="text-5xl lg:text-6xl font-bold text-[#1E3A8A] mb-4 leading-tight">{t.shipping.title}</h1>
      ...
      <section className="pb-16 lg:pb-20">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <AnimatedSection>
            <h2 className="text-2xl font-bold text-[#1E3A8A] mb-6 text-center">{t.shipping.deliveryTableTitle}</h2>
            <div className="bg-white rounded-2xl border border-gray-100 overflow-hidden" style={{ boxShadow: "0 4px 20px rgba(0,0,0,0.25)" }}>
              <div className="overflow-x-auto">
                <table className="w-full text-sm" dir={dir}>
                  <thead>
                     <tr className="bg-[#F8FAFC] text-[#1E40AF]">
                  ...
                  <tbody>
                    {(t.shipping.deliveryTable as unknown as { region: string; eta: string; fee: string; free: string }[]).map((row, i) => (
                      <tr key={i} className={i % 2 === 1 ? "bg-gray-50/60" : ""}>
                        ...
                        <td className="py-3 px-4 text-[#1E3A8A] font-medium">{row.free}</td>
                      </tr>
                    ))}
                  </tbody>
                </table>
      ...
      <section className="py-16 lg:py-20">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
              ...
              <AnimatedSection key={i}>
                ...
                >
                  ...
                  <div className="min-w-0">
                    <h2 className="text-xl font-bold text-[#1E3A8A] mb-3">{s.title}</h2>
          ...
          <AnimatedSection>
            <div className="mt-12 bg-[#F8FAFC] rounded-3xl p-8 lg:p-10 text-center border border-[#E2E8F0]">
              ...
              <h2 className="text-2xl font-bold text-[#1E3A8A] mb-2">{t.shipping.title}</h2>
