...
const values = [
  { icon: <Heart className="w-6 h-6" />, title: "Compassion", text: "Every pet deserves love and respect" },
  { icon: <Shield className="w-6 h-6" />, title: "Quality", text: "Only the best products and care" },
  { icon: <Users className="w-6 h-6" />, title: "Community", text: "Building a family of pet lovers" },
  { icon: <Award className="w-6 h-6" />, title: "Excellence", text: "Highest standards in pet care" },
  { icon: <Leaf className="w-6 h-6" />, title: "Sustainability", text: "Eco-friendly products and practices" },
  { icon: <Smile className="w-6 h-6" />, title: "Trust", text: "Honest advice and transparent pricing" },
];
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <AnimatedSection>
            <span className="inline-flex items-center gap-2 px-4 py-1.5 bg-white/10 backdrop-blur-xl rounded-full text-sm text-emerald-200 border border-white/10 mb-5">
              <Sparkles className="w-4 h-4" /> Since 2012
            </span>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
                ...
                <div className="absolute -bottom-6 -right-6 bg-white rounded-2xl px-6 py-4 shadow-xl border border-gray-100 hidden lg:block">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <div className="text-xs text-gray-500">Happy Pets Served</div>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <AnimatedSection>
              ...
              <h2 className="text-4xl font-bold text-gray-900 mb-5 leading-tight">A Journey of Love for Pets</h2>
          ...
          <AnimatedSection>
            <div className="max-w-2xl mx-auto text-center mb-12">
              <span className="inline-flex items-center gap-2 px-4 py-1.5 bg-white rounded-full text-sm text-[#8B7560] border border-emerald-200/50 shadow-sm mb-3">
                <Heart className="w-4 h-4" /> Our Purpose
              </span>
