  ...
  return (
    <div>
      <section className="relative overflow-hidden py-16 lg:py-28">
        <div className="absolute inset-0">
          <Image
            ...
            priority
          />
          <div className="absolute inset-0 bg-gradient-to-r from-[#0E1611]/90 via-[#0E1611]/70 to-[#0E1611]/60" />
          <div className="absolute inset-0 bg-gradient-to-t from-[#0E1611] via-transparent to-transparent opacity-60" />
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            <AnimatedSection>
              ...
              <h2 className="text-4xl font-bold text-[#1E2D24] mb-5 leading-tight">{t.about.storyTitle}</h2>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <AnimatedSection>
            <div className="max-w-2xl mx-auto text-center mb-12">
              ...
              <h2 className="text-4xl font-bold text-[#1E2D24] mb-4">{t.about.mission}</h2>
              <p className="text-gray-600 text-lg leading-relaxed">{t.about.missionText}</p>
            </div>
          </AnimatedSection>

          <AnimatedSection>
            <h2 className="text-3xl font-bold text-[#1E2D24] mb-10 text-center">{t.about.values}</h2>
      ...
      <section className="relative overflow-hidden py-16 lg:py-20"
        style={{ background: "linear-gradient(135deg, #0E1611 0%, #1E2D24 50%, #0E1611 100%)" }}
      >
